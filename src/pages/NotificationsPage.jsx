  ...
  if (loading) {
    return (
      <div className="bg-[#f9f9f9] min-h-screen flex flex-col">
        <Navbar notifCount={notifications.length} />
        <div className="p-6 animate-pulse flex-grow">Loading...</div>
        <Footer />
      </div>
    );
  }
  ...
  return (
    <div className="bg-[#f9f9f9] min-h-screen flex flex-col animate-fade-in">
      ...
      <div className="p-6 flex-grow">
        ...
        {notifications.length === 0 ? (
          <div className="flex flex-col items-center justify-center mt-20 text-center">
            ...
            />
            <h2 className="text-lg font-semibold text-[#071d49]">No Notifications</h2>
                ...
                >
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                      {!isRead && <Circle size={10} className="text-blue-500 fill-blue-500" />}
                  ...
                  <div className="flex items-center justify-between mt-3 text-sm text-gray-500">
                    ...
                    <span className={`italic ${isRead ? "text-gray-400" : "text-blue-500"}`}>
                      {isRead ? "Read" : "Unread"}
                    </span>
                  </div>
                </div>
      ...
      <style>{`
        ...
        .animate-fade-in { animation: fadeIn 0.4s ease-in-out both; }
