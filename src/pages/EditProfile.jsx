...
const EditProfile = () => {
  ...
  // Elegant spinner while loading
  if (loading) {
    return (
      <div className="min-h-screen bg-[#f9f9f9] flex items-center justify-center relative overflow-hidden">
        {/* Background Shapes */}
  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9] flex justify-center items-center px-4 font-inter relative overflow-hidden">
